...
return [
    ...
    */
    ...
    'custom'               => [
        'expiring_date' => [
            'after_or_equal' => 'Token scaduto contattare l\' utente che le ha inviato la mail di registrazione',
            'required' => 'Token scaduto contattare l\' utente che le ha inviato la mail di registrazione',
        ],

        'cryptedData' => [
            'required' => 'token non valido contatare un amministratore',
        ],
    ],
